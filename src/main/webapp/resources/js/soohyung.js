...
soohyung.main=(()=>{
   ...
   /*   soohyung.template.joinheadUI();
      soohyung.template.joinUI();*/
...
soohyung.template=(()=>{
   ...
   var joinUI=()=>{
      $('#content').append(         
            ...
            +'                        </th>'
            +'                        <td>'
            +'                          <span class="input_txt"><input type="text"  class="text readonly member_name" id="input_member_name"></span><!-- 에러시 .error 클래스 추가 -->'
            +'                        </td>'
            +'                      </tr>'
            +'                      <tr class="input">'
            +'                        <th scope="row" class="mandatory">'
            ...
            +'                            <a class="btn btn_sm"  href="javascript://;"><span class="arr">CJ ONE 통합 아이디 안내</span></a>'
            ...
            +'                          </div>'
            +'                          <p class="msg_desc">영문자, 숫자,특수문자 조합하여 8~12자리, 아이디와 4자리이상 동일,반복 문자숫자 불가<br>'
            +'                     사용 가능 특수 문자 : !"#$%&amp;'+'()*+,-./:;&lt;=&gt;?@[]^'+'{|}~</p>'
            +'                        </td>'
            +'                      </tr>'
            +'                      <tr class="input">'
   ...
   return {loginUI : loginUI, navbarUI : navbarUI, footerUI : footerUI, joinUI : joinUI, joinheadUI : joinheadUI}
})();
